...
def average_over_repetitions(backup, n_repetitions, n_timesteps, max_episode_length, learning_rate, gamma,
                             policy='egreedy', epsilon=None, temp=None, smoothing_window=51, plot=False, n=5
                             ):
...
def experiment():
    ...
    print('Starting assignment 2 Effect of exploration')
    backup = 'q'
    ...
    print('Starting assignment 3 Q-learning versus SARSA')
    backups = ['q', 'sarsa']
    ...
    print('Starting assignment 4 Back-up depth')
    backup = 'nstep'
    ns = [1, 3, 5, 10, 20, 100]
